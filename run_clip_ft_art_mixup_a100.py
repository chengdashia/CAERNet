...
CONFIGS = [
    CAERNET_DIR / "configs/experiments/clip_adapter_vit_b16_ft_art_mixup_no_energy.yaml",
    CAERNET_DIR / "configs/experiments/clip_adapter_vit_b16_ft_art_mixup_no_contrastive.yaml",
    CAERNET_DIR / "configs/experiments/clip_adapter_vit_b16_ft_art_mixup.yaml",
]
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run partial-finetuning CLIP art/mixup experiments on A100.",
    )
    ...
    print(f"Starting CLIP fine-tuning sequence on hardware={args.hardware}")
    ...
    print()
    print("All CLIP fine-tuning runs finished.")
    return 0
